...
export const setupCustomBlocks = (editor: Editor) => {
  ...
  editor.BlockManager.add("div", {
    ...
    media: '<svg viewBox="0 0 24 24" width="24" height="24"><rect x="3" y="5" width="18" height="14" rx="2" fill="#e5e7eb" stroke="#374151" stroke-width="1.5"/><rect x="3" y="5" width="18" height="4" rx="1" fill="#6366f1"/><text x="12" y="14" text-anchor="middle" font-size="7" font-weight="bold" fill="#374151">Div</text></svg>'
  });
  ...
  editor.BlockManager.add("paragraph", {
    ...
    media: '<svg viewBox="0 0 24 24" width="24" height="24"><rect x="3" y="5" width="18" height="14" rx="2" fill="#e5e7eb" stroke="#374151" stroke-width="1.5"/><rect x="3" y="5" width="18" height="4" rx="1" fill="#6366f1"/><text x="12" y="14" text-anchor="middle" font-size="7" font-weight="bold" fill="#374151">P</text></svg>'
  });
  ...
  editor.BlockManager.add("footer", {
    ...
    content: `
      <footer></footer>
    `,
    media: '<svg viewBox="0 0 24 24" width="24" height="24"><rect x="2" y="17" width="20" height="5" rx="2" fill="#111827" stroke="#374151" stroke-width="1.5"/><text x="12" y="21" text-anchor="middle" font-size="7" font-weight="bold" fill="#fff">Footer</text></svg>'
  });
  ...
  editor.BlockManager.add("list", {
    ...
    media: '<svg viewBox="0 0 24 24" width="24" height="24"><circle cx="6" cy="7" r="2" fill="#6366f1"/><circle cx="6" cy="12" r="2" fill="#6366f1"/><circle cx="6" cy="17" r="2" fill="#6366f1"/><rect x="10" y="6" width="10" height="2" rx="1" fill="#e5e7eb"/><rect x="10" y="11" width="10" height="2" rx="1" fill="#e5e7eb"/><rect x="10" y="16" width="10" height="2" rx="1" fill="#e5e7eb"/></svg>'
  });
}; 